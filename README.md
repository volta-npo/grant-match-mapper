...
![Volta OSS](https://img.shields.io/badge/Volta%20OSS-v3%20production%20ready-16a34a?style=for-the-badge)
...
[Live app](https://volta-npo.github.io/grant-match-mapper/) · [Report an issue](https://github.com/volta-npo/grant-match-mapper/issues) · [Volta](https://voltanpo.org)
...
**Grant Match Mapper** is a polished, local-first open-source tool from Volta's 50-project OSS division. It helps Finance students researching funding for nonprofits and small businesses turn real community work into structured evidence, client-safe handoffs, and mentor-reviewable release packets.
...
```bash
git clone https://github.com/volta-npo/grant-match-mapper.git
