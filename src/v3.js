export const v3 = {
    ...
    "capabilities": [
        "Domain-specific workbench: Grant Fit Mapping Desk",
        "Operational table: Grant opportunities",
    ...
    "releaseChecklist": [
        ...
        "Grant Fit reaches production threshold",
        "Evidence Confidence is documented with evidence",
        "Deadline Readiness has no unresolved blocker",
        "Grant shortlist CSV verified",
        "Funder-ready match brief verified",
        "Missing-info request verified"
    ],
    "operations": [
